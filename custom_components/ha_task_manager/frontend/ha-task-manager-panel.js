...
let HaTaskManagerPanel = class HaTaskManagerPanel extends i {
    constructor() {
        super(...arguments);
...
__decorate([
    n({ attribute: false })
], HaTaskManagerPanel.prototype, "hass", void 0);
__decorate([
    r()
], HaTaskManagerPanel.prototype, "currentView", void 0);
HaTaskManagerPanel = __decorate([
    t("ha-task-manager-panel")
], HaTaskManagerPanel);

export { HaTaskManagerPanel };
